...
int main() {
    ...
    while (1) {
        if (scanf("%19s", players[0].name) != 1) {
            fprintf(stderr, "Greska pri unosu imena igraca X\n");
            return 1;
        }

        if (!is_name_available(players[0].name)) {
            printf("Ime '%s' je vec zauzeto. Unesite drugo ime: ", players[0].name);
            continue;
        }
        break;
    }
    ...
    while (1) {
        if (scanf("%19s", players[1].name) != 1) {
            fprintf(stderr, "Greska pri unosu imena igraca O\n");
            return 1;
        }

        if (!is_name_available(players[1].name) || strcmp(players[1].name, players[0].name) == 0) {
            printf("Ime '%s' je vec zauzeto. Unesite drugo ime: ", players[1].name);
            continue;
        }
        break;
    }
